...
def preprocess_input(input_df):
    ...
    if EXPECTED_FEATURES_AFTER_PREPROCESSING:
        ...
        if any(count > 0 for count in non_finite_counts.values()):
        ...
        if hasattr(pca_model, 'feature_names_in_'):
             pca_model.feature_names_in_ = expected_features # Explicitly set names
