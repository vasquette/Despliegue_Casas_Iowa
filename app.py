...
def preprocess_input(input_df):
    ...
    if ohe_cols_in_df:
        try:
            # Fill NaN values in categorical columns with the first category if available
            ...
            # This prevents errors if new categories appear in the input data
            # Assuming the loaded onehot_encoder was trained with handle_unknown='ignore'
            ...
            df_processed = pd.concat([df_processed, encoded_df], axis=1)
             ...
             st.warning(f"Could not apply One-Hot Encoding: {e}")
