...
def get_input_data_from_widgets():
    ...
    # Changed default index from 4 (np.nan) to 0 ('Attchd')
    ...
    # Changed default index from 0 (np.nan) to 1 ('Grvl')
    ...
    # Changed default index from 0 ('None') to 1 ('BrkFace') as 'None' is a valid category, not NaN
    ...
    # Changed default index from 0 ('SBrkr') to 1 ('FuseA') as 'SBrkr' is a valid category, not NaN, and we want to avoid the first option if it's NaN.
    ...
    input_data['Fireplaces'] = st.sidebar.number_input('Fireplaces', min_value=0, value=0, step=1, key='Fireplaces')
    # Changed default index from 0 (np.nan) to 1 ('Gd')
